...
{
	std::ofstream fout("9threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/9);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/9, (imageHeight/9)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/9)*2, (imageHeight/9)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/9)*3, (imageHeight/9)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/9)*4, (imageHeight/9)*5);
    std::thread thread6(generateImageSection, std::ref(colorVect), (imageHeight/9)*5, (imageHeight/9)*6);
    std::thread thread7(generateImageSection, std::ref(colorVect), (imageHeight/9)*6, (imageHeight/9)*7); 
    std::thread thread8(generateImageSection, std::ref(colorVect), (imageHeight/9)*7, (imageHeight/9)*8);
    std::thread thread9(generateImageSection, std::ref(colorVect), (imageHeight/9)*8, imageHeight);	
