...
{
	std::ofstream fout("8threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/8);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/8, (imageHeight/8)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/8)*2, (imageHeight/8)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/8)*3, (imageHeight/8)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/8)*4, (imageHeight/8)*5);
    std::thread thread6(generateImageSection, std::ref(colorVect), (imageHeight/8)*5, (imageHeight/8)*6);
    std::thread thread7(generateImageSection, std::ref(colorVect), (imageHeight/8)*6, (imageHeight/8)*7); 
    std::thread thread8(generateImageSection, std::ref(colorVect), (imageHeight/8)*7, imageHeight);
