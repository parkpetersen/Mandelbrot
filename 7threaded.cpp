...
{
	std::ofstream fout("7threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/7);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/7, (imageHeight/7)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/7)*2, (imageHeight/7)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/7)*3, (imageHeight/7)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/7)*4, (imageHeight/7)*5);
    std::thread thread6(generateImageSection, std::ref(colorVect), (imageHeight/7)*5, (imageHeight/7)*6);
    std::thread thread7(generateImageSection, std::ref(colorVect), (imageHeight/7)*6, imageHeight); 
