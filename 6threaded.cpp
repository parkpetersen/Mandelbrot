...
{
	std::ofstream fout("6threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/6);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/6, (imageHeight/6)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/6)*2, (imageHeight/6)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/6)*3, (imageHeight/6)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/6)*4, (imageHeight/6)*5);
    std::thread thread6(generateImageSection, std::ref(colorVect), (imageHeight/6)*5, imageHeight); 
