...
{
	std::ofstream fout("11threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/11);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/11, (imageHeight/11)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/11)*2, (imageHeight/11)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/11)*3, (imageHeight/11)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/11)*4, (imageHeight/11)*5);
    std::thread thread6(generateImageSection, std::ref(colorVect), (imageHeight/11)*5, (imageHeight/11)*6);
    std::thread thread7(generateImageSection, std::ref(colorVect), (imageHeight/11)*6, (imageHeight/11)*7); 
    std::thread thread8(generateImageSection, std::ref(colorVect), (imageHeight/11)*7, (imageHeight/11)*8);
    std::thread thread9(generateImageSection, std::ref(colorVect), (imageHeight/11)*8, (imageHeight/11)*9);	
    std::thread thread10(generateImageSection, std::ref(colorVect), (imageHeight/11)*9, (imageHeight/11)*10);
    std::thread thread11(generateImageSection, std::ref(colorVect), (imageHeight/11)*10, imageHeight);
