...
{
	std::ofstream fout("4threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/4);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/4, (imageHeight/4)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/4)*2, (imageHeight/4)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/4)*3, imageHeight); 
