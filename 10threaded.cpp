...
{
	std::ofstream fout("10threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/10);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/10, (imageHeight/10)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/10)*2, (imageHeight/10)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/10)*3, (imageHeight/10)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/10)*4, (imageHeight/10)*5);
    std::thread thread6(generateImageSection, std::ref(colorVect), (imageHeight/10)*5, (imageHeight/10)*6);
    std::thread thread7(generateImageSection, std::ref(colorVect), (imageHeight/10)*6, (imageHeight/10)*7); 
    std::thread thread8(generateImageSection, std::ref(colorVect), (imageHeight/10)*7, (imageHeight/10)*8);
    std::thread thread9(generateImageSection, std::ref(colorVect), (imageHeight/10)*8, (imageHeight/10)*9);	
    std::thread thread10(generateImageSection, std::ref(colorVect), (imageHeight/10)*9, imageHeight);
