...
{
	std::ofstream fout("5threadedMandelbrot"+std::to_string(i)+".ppm");
	fout << "P3" << std::endl;
...
void generateImage()
{
    ...
    std::thread thread1(generateImageSection, std::ref(colorVect), 0, imageHeight/5);
    std::thread thread2(generateImageSection, std::ref(colorVect), imageHeight/5, (imageHeight/5)*2);
    std::thread thread3(generateImageSection, std::ref(colorVect), (imageHeight/5)*2, (imageHeight/5)*3);
    std::thread thread4(generateImageSection, std::ref(colorVect), (imageHeight/5)*3, (imageHeight/5)*4);
    std::thread thread5(generateImageSection, std::ref(colorVect), (imageHeight/5)*4, imageHeight); 
